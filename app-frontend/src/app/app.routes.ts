...
export const routes: Routes = [
  ...
  },
  {
    path: 'dashboard',
    loadComponent: () =>
      import('./app/dashboard/dashboard').then(m => m.DashboardComponent)
  },
  {
    path: 'vehiculos',
    loadComponent: () =>
      import('./app/vehiculos/vehiculo').then(m => m.VehiculosComponent)
  },
  {
    path: 'rutas',
    loadComponent: () =>
      import('./app/rutas/rutas').then(m => m.RutasComponent)
  },
  { path: '**', redirectTo: '' }
];
